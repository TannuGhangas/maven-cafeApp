// src/components/common/ProfileImageFallback.jsx

import React from 'react';

/**
 * Simplified fallback ProfileImage component without complex hooks
 * Used when the main ProfileImage component fails
 */
const ProfileImageFallback = ({
    ...
    // Simple function to get profile image
    const getProfileImage = () => {
        try {
            ...
            console.warn('⚠️ ProfileImageFallback: Error getting profile image:', error);
        }
    ...
    const handleImageError = () => {
        console.warn('⚠️ ProfileImageFallback: Image failed to load');
    };
    ...
    const getDisplayName = () => {
        try {
            ...
            console.warn('⚠️ ProfileImageFallback: Error getting display name:', error);
        }
